...
class Form(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.ui.setWindowTitle("MOVIE REGERVATION")
        self.resize(700,1000)
        self.ui.setWindowIcon(QIcon("image/icon.png"))
    ...
    def slot_1st(self):
        ...
        pixmap_resized = pixmap.scaled(320, 480, Qt.KeepAspectRatio, Qt.FastTransformation)    ## 원래의 이미지 크기가 상당히 컸기 때문에 scaled를 통해서 줄였다.
